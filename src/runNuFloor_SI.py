...
n_ex = 650 # number of exposure points (I wouldn't go below 250)
ns = 650 # number of cross section points (I wouldn't go below 250)
ex_min = 1e-6 # minimum exposure
...
sigma_max = 1e-41 # Maximum cross section to scan over
